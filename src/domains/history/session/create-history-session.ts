...
export function createHistorySession(
  documentStore: Parameters<typeof createHistoryCommandExecutor>[0]['documentStore'],
) {
  ...
  function rehydrateHistory(
    ...
    if (documentStore.pages.length === 0 && clampedPointer >= 0) {
...
export type HistorySession = ReturnType<typeof createHistorySession>
