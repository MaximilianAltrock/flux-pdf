...
import { EXPORT_PROGRESS, PAGE_NUMBER_BASE, PDF_PAGE_INDEX_BASE } from '@/shared/constants'
import type { PDFPage } from 'pdf-lib'
import type { OutlineNode, PageEntry, PageReference, DocumentMetadata, RedactionMark } from '@/shared/types'
...
export interface ExportOptions {
  ...
  compress?: boolean
  compressionQuality?: import('@/domains/export/application/usePdfCompression').CompressionQuality | 'none'
  outline?: {
    include?: boolean
    flatten?: boolean
    expandAll?: boolean
