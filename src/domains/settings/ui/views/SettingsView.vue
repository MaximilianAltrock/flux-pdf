...
import { useStorageGC } from '@/domains/settings/application'
import { useToast } from '@/shared/composables/useToast'
import { useSettingsStore, type ThemePreference } from '@/domains/settings/store'
...
import SettingsCategoryNav from '@/domains/settings/ui/components/SettingsCategoryNav.vue'
import SettingsGeneralSection from '@/domains/settings/ui/components/SettingsGeneralSection.vue'
import SettingsEditorSection from '@/domains/settings/ui/components/SettingsEditorSection.vue'
import SettingsExportSection from '@/domains/settings/ui/components/SettingsExportSection.vue'
import SettingsStorageSection from '@/domains/settings/ui/components/SettingsStorageSection.vue'
