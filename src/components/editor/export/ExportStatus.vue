...
<template>
  <div>
    ...
    >
      ...
      <h3 class="text-lg font-bold tracking-tight text-foreground mb-1">Export complete</h3>
      ...
      >
        ...
        <div class="flex justify-between items-center pt-1.5 border-t border-border/30">
          ...
          <div class="flex flex-col items-end">
            ...
            <span
              v-if="stats.compressionRatio != null && stats.originalSizeKB != null"
              class="ui-mono text-xs text-primary"
            >
    ...
    <div v-else-if="isExporting" class="py-8 flex flex-col items-center">
      ...
      <div class="text-center space-y-1">
        ...
        <span class="ui-kicker ui-mono opacity-70">Processing pages...</span>
      </div>
